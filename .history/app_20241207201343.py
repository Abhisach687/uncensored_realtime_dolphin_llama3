...
{agent_scratchpad}"""
    ...
    return agent_executor, tools  # Return both the agent executor and the tools list
...
agent_executor, tools = create_agent()  # Unpack both agent executor and tools
    ...
    if user_input.strip():
        with st.spinner("Fetching the latest information..."):
            try:
                ...
                agent_scratchpad = agent_scratchpad = ""  # Initialize as empty or use previous context if needed
