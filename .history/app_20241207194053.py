...
1. Think about the question step by step.
2. Consider which tools, if any, can help answer the question.
3. If a tool can help, explain why and then use it.
4. After receiving the tool's result, provide the final answer to the user.

Question: {input}
Thought:"""

    prompt = PromptTemplate(
        input_variables=["tool_descriptions", "input", "tools", "tool_names", "agent_scratchpad"],
        template=template
    )
